 ...
 * 
 * @param bagId number of the bag the item is in, 0 is your backpack, 1-4 are the four additional bags, numbered right to left. Actually, for this method, this parameter is valid as API_ContainerIDToInventoryID
 ...
 * Open all bag frames
 * 
 * @param frame The frame that is responsible for opening the bags. Doesn't affect the operation of this function but sets an internal variable that affects other container frame functions. Can be nil
 ...
 * 
 * @param inventorySlotId Inventory slot id containing the bag in which you wish to put the item. Values 20 to 23 correspond to the player's bag slots, right-to-left from the first bag after the backpack
