 ...
 * Retrieve Information about a currency at index including it's amount
 * 
 * @param currencyId The full currencyLink as found with GetCurrencyLink() or GetCurrencyListLink(). OR A fragment of the currencyLink string for the item, e.g. "currency:396" for Valor Points.
 * @returns name, currentAmount, texture, earnedThisWeek, weeklyMax, totalMax, isDiscovered, rarity
 * @see https://wow.gamepedia.com/API_GetCurrencyInfo
 * @since 3.0.2
 */
 ...
 * @returns The currency link (similar to itemLink) for the specified index (e.g. "|cffa335ee|Hcurrency:396:0|h[Valor Points]|h|r" for Valor Points) or nil if the index is for a header
