 ...
 */
declare function GetAuctionItemLink(type: AUCTION_TYPE, index: number): WowItemLink | null;
 ...
 */
declare function GetContainerItemLink(bagId: WOW_CONTAINER_ID, slotIndex: number): WowItemLink | null;
 ...
 */
declare function GetItemCount(itemIdentifier: string | number | WowItemLink, includeBank?: boolean, includeCharges?: boolean): number;
 ...
 */
declare function GetItemFamily(itemIdentifier: string | number | WowItemLink): BAG_TYPE;
 ...
 */
declare function GetItemSpell(itemIdentifier: string | number | WowItemLink): [string, string, number];
 ...
 */
declare function GetItemStats(itemLink: WowItemLink, statTable?: {}): { [index: string]: number };
 ...
 */
declare function GetQuestItemLink(type: WowQuestType, index: number): WowItemLink;
 ...
 */
declare function GetTradeSkillReagentItemLink(skillId: number, reagentId: number): WowItemLink;
 ...
 * @param itemIdentifier Number/String/String - Numeric ID of the item, name of the item, or itemLink of the item to query
 */
declare function IsUsableItem(itemIdentifier: string | number | WowItemLink): [boolean, boolean];
 ...
 */
declare function IsConsumableItem(itemIdentifier: string | number | WowItemLink): WowFlag;

/**
 * unknown
 * @param itemIdentifier An item ID (number), item link or item name (string) to query
 */
declare function IsCurrentItem(itemIdentifier: string | number | WowItemLink): WowFlag;
 ...
 */
declare function IsEquippedItem(itemIdentifier: string | number | WowItemLink): boolean;
 ...
 */
declare function IsEquippableItem(itemIdentifier: string | number | WowItemLink): boolean;
 ...
 */
declare function IsItemInRange(itemIdentifier: string | number | WowItemLink, unit?: WowUnitId): [boolean, WowFlag];

/**
 * unknown
 * @param itemIdentifier Number/String/String - Numeric ID of the item, name of the item, or itemLink of the item to query
 */
declare function ItemHasRange(itemIdentifier: string | number | WowItemLink): boolean;
 ...
 */
declare function SetItemRef(link: WowItemLink, text: string, button: WowMouseButton): void;
