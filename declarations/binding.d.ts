 ...
 * @returns ACCOUNT_BINDINGS = 1 (indicates that account-wide bindings are currently active), CHARACTER_BINDINGS = 2  (indicates that per-character bindings are currently active)
