declare type WowTypedEvents = {
     ...
     */
    CHAT_MSG_ACHIEVEMENT: [string, string, string, string, string, WowUnknown, ...number[]];
     ...
     */
    CHAT_MSG_CHANNEL: [string, string, string, string, string, WowChatFlag, number, number, string, WowUnknown, number, WowGuid];
     ...
     */
    CHAT_MSG_CHANNEL_JOIN: [WowUnknown, string, WowUnknown, string, number, string];
     ...
     */
    CHAT_MSG_CHANNEL_NOTICE_USER: [WowChatUserNoticeType, string, WowUnknown, string, string];
     ...
     */
    CHAT_MSG_GUILD_ACHIEVEMENT: [string, string, WowUnknown, WowUnknown, string, ...WowUnknown[]];
     ...
     */
    CHAT_MSG_LOOT: [string, WowUnknown, WowUnknown, WowUnknown, string, ...WowUnknown[]];
     ...
     */
    CHAT_MSG_RAID_BOSS_EMOTE: [WowUnknown, string, WowUnknown, WowUnknown, string, ...WowUnknown[]];
     ...
     */
    CHAT_MSG_WHISPER: [string, string, string, WowUnknown, WowUnknown, WowChatFlag, number, number, ...WowUnknown[]];
     ...
     */
    ITEM_LOCK_CHANGED: [WOW_CONTAINER_ID | WOW_INVENTORY_SLOT_ID, WOW_INVENTORY_SLOT_ID?];
     ...
     */
    PARTY_INVITE_REQUEST: [string, boolean, boolean, boolean, boolean, WowUnknown];
     ...
     */
    UNIT_COMBAT: [WowUnitId, WowCombatTextType, WowCombatCriticalIndicator, number, WowCombatDamageType];
     ...
     */
    UNIT_ENTERED_VEHICLE: [WowUnitId, boolean, string, WowVehicleType, boolean, number, WowGuid, boolean, boolean];
